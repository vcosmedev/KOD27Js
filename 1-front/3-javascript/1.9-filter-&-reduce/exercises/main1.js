...
let data = [
  ...
  // Get allSpecies
  let allSpecies = data.reduce((accum, curr) => {
    return accum.includes(curr.species) ? accum : [...accum, curr.species];
  }, []);

  console.log(allSpecies);

  // Get all location > name
  let allLocations = data.reduce((accum, curr) => {
    return accum.includes(curr.location.name) ? accum : [...accum, curr.location.name];
  }, []);
