let rickNMorty = [
  ...
  const createCharacterCard = (characterObject) => {
    ...
    characterNameItem.innerText = name;

    let characterEpisodeItem = document.createElement("p");
  ...
  const printRNMCharacters = (rickNMortyArray) => {
    let charactersList = document.getElementById("rickNMorty-card");
    rickNMortyArray.forEach((character) => {
        let listCharacter = createCharacterCard(character);
        charactersList.appendChild(listCharacter);
    })
  }
