...
const getAveragePrice = (productArr) => {
    ...
    priceAverage = priceSum / productArr.length;
    return priceAverage;
}
...
const getProductRate = (productArr) => {
    ...
    for (let i = 0; i < productArr.length; i++) {
        let product = productArr[i];
        product.rating.rate >= 4 && rateProduct.push(product);
    }
    return rateProduct;
}
...
const getProductRateFiltered = (productArr) => {
    ...
    for (let i = 0; i < productArr.length; i++) {
        let product = productArr[i];
        product.rating.rate >= 4 && rateProduct.push(product.title) && rateProduct.push(product.rating);
    }
    return rateProduct;
}
...
const getProductCategory = (productArr, category) => {
    ...
    for (let i = 0; i < productArr.length; i++) {
        ...
        productCategory === category && categoryProduct.push(product.title);
    }
    return categoryProduct;
}

console.log(getProductCategory(products, "electronics"));