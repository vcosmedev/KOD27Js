...
console.log(milaneso);
milaneso.vaccinesList = ["Parvovirus", "Quintuple"]; // Add new property and value to an object
milaneso.owner = { // Add new property and value to an object
    name: "Ander",
...
console.log(milaneso.owner.name); // Navigate intro object's property -> Access to property's object (nesting)
console.log(milaneso.owner.address.district); // Navigate intro object's property -> Access to property's object (nesting)
